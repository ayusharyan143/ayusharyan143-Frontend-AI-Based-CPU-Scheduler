...
class ProcessSchedulingEnv(gym.Env):
    def __init__(self):
        ...
        base_path = os.path.join(os.path.dirname(__file__), 'burst_time_prediction')
        self.burst_predictor = joblib.load(os.path.join(base_path, 'burst_time_predictor.joblib'))
        self.scaler = joblib.load(os.path.join(base_path, 'feature_scaler.joblib'))
